...
const useSWRHandler = (_key, fetcher, config)=>{
    ...
    const returnedData = keepPreviousData ? isUndefined$1(cachedData) ? (_laggyDataRef_current = laggyDataRef.current) != null ? _laggyDataRef_current : data : cachedData : data;
